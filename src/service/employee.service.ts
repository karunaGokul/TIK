...
export interface IEmployeeService {
  ...
  GetMerchandiser(
    request: AdminRequestModel
  ): Promise<Array<MerchandiserResponseModel>>;
  GetMasterAdmin(
    request: AdminRequestModel
  ): Promise<Array<MasterAdminResponseModel>>;
  GetApprovalAdmin(
    request: AdminRequestModel
  ): Promise<Array<ApprovalAdminResponseModel>>;
...
export class EmployeeService extends ServiceHelper implements IEmployeeService {
  ...
  public CreateEmployee(request: EmployeeModel): Promise<any> {
    return this.httpPost("employee/CreateEmployee", request).then(
      (response) => {
        return response.data;
      }
    );
  ...
  public EditEmployee(
    ...
    return this.httpPost(
      "employee/EditEmployee?EmployeeId=" + EmployeeId,
      request
    ).then((response) => {
      return response.data;
    });
