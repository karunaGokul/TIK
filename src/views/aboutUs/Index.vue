<template>
  <div>
    ...
    <v-row>
      ...
      <v-col class="col-8">
        <p class="pr-5">
          ...
          quam id enim modi placeat totam voluptas praesentium beatae molestiae
          et. Earum doloremque maxime qui? Possimus aperiam, beatae blanditiis
          saepe sed hic temporibus. Tempore, quaerat. Alias, pariatur? Illo
          asperiores corporis praesentium animi reiciendis earum eos nulla
          magnam. Ipsam odit asperiores, fugit explicabo voluptatibus aliquid
          quidem.
        </p>
        <v-btn
          color="#ff6500"
    ...
    <p class="ml-16 mr-10">
      ...
      necessitatibus praesentium temporibus id explicabo tenetur illum adipisci
      repellat, totam doloribus. Voluptatem, laborum. Dignissimos, numquam quos
      quia corporis qui quidem illo, error id hic, repellendus exercitationem.
      Consequuntur, aperiam. Cumque distinctio corporis nihil, recusandae ad
      quod, assumenda dignissimos, doloribus adipisci esse magnam minus! Porro
      suscipit fugit modi, nam ex accusantium maiores omnis recusandae
      consequatur, obcaecati doloribus fuga! Qui libero deserunt modi explicabo
      aut dolorum, voluptas, tempora itaque error facere adipisci blanditiis
      iste nostrum? Dignissimos quis esse explicabo quam in iste velit quos illo
      accusamus dolor. Temporibus, doloremque!
    </p>
    ...
    <div class="white--text teal darken-4 color rounded-0 pb-10 pt-6">
      <v-row>
        <v-col class="pl-16 col-4">
          <subtitle-1> Gain a Success with Us </subtitle-1>
          <h1 class="text-decoration-underline">Get to know us better!</h1>
        </v-col>
        <v-col class="text-capitalize">
          <h1 class="text-decoration-underline">1530+</h1>
          <subtitle-1> happy clients </subtitle-1>
        </v-col>
        <v-col class="text-capitalize">
          <h1 class="text-decoration-underline">1240+</h1>
          <subtitle-1> projects finished </subtitle-1>
        </v-col>
        <v-col class="text-capitalize">
          <h1 class="text-decoration-underline">1380+</h1>
