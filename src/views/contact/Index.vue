  ...
  <v-container>
    ...
    <v-row>
      <v-col v-for="contact in contacts" :key="contact.title" cols="12" sm="4">
        <v-card justify="center" align="center" min-height="240">
          ...
          <v-card-text class="text-subtitle-1 black--text">
            <div class="pb-2">{{ contact.description }}</div>
          </v-card-text>
        </v-card>
      </v-col>
    </v-row>
    ...
    <div class="my-15" justify="center" align="center">
      <h1 class="text-capitalize">send us a message</h1>
      <Divider />
    </div>

    <v-row class="grey lighten-4 pa-4">
      <v-col>
        <v-img src="@/assets/gallery/gallery1.png" />
      </v-col>

      <v-col>
        <v-form>
          <v-text-field solo label="Enter Name"></v-text-field>
          <v-text-field solo label="Enter Email"></v-text-field>
          <v-textarea solo label="Enter Message"></v-textarea>
